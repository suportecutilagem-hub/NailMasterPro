        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-[hsl(var(--rose-primary))] text-white rounded-full p-4 shadow-lg">
                <div className="text-center">
              ...
              <div className="absolute top-1/2 -left-8 bg-[hsl(var(--teal))] text-white rounded-lg p-3 shadow-lg hidden lg:block">
                <div className="text-center">
