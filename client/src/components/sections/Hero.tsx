            ...
            >
              <a href="https://pay.cutilagemrussa.com/checkout-6880/?add-to-cart=6880" className="block">
                <Button 
                  variant="cta" 
                  size="xl" 
                  className="w-full lg:w-auto uppercase font-bold tracking-wide shadow-lg relative overflow-hidden group transition-all duration-300 text-xs sm:text-sm py-3 sm:py-4 px-2 sm:px-4"
                >
                  <span className="relative z-10 leading-tight whitespace-nowrap">
