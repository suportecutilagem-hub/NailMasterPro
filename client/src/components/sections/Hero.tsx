        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-2 mb-5">
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                <div className="bg-rose-100 border border-rose-200 rounded-lg px-3 py-2.5 flex items-center shadow-sm">
                  ...
                  <span className="text-sm sm:text-base text-gray-900 font-medium">6 Certificados Inclusos</span>
                </div>
                ...
                <div className="bg-rose-100 border border-rose-200 rounded-lg px-3 py-2.5 flex items-center shadow-sm">
                  ...
                  <span className="text-sm sm:text-base text-gray-900 font-medium">+11 Bônus Exclusivos</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-lg border-2 border-[hsl(var(--rose-primary))]/20 mb-5">
              ...
              <div className="grid grid-cols-1 gap-2 text-xs text-gray-600 sm:grid-cols-2 sm:text-sm">
