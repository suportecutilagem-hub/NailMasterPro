          ...
          >
            ...
            <div className="space-y-2 mb-5">
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-gradient-to-r from-rose-400 via-pink-500 to-rose-500 border border-rose-300 rounded-lg px-3 py-2.5 flex items-center shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 text-white mr-1.5 sm:mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" />
                  </svg>
                  <span className="text-sm sm:text-base font-semibold text-white whitespace-nowrap">6 Certificados Inclusos</span>
                </div>
                ...
                <div className="bg-gradient-to-r from-rose-400 via-pink-500 to-rose-500 border border-rose-300 rounded-lg px-3 py-2.5 flex items-center shadow-md">
                  ...
                  <span className="text-sm sm:text-base font-semibold text-white whitespace-nowrap">+11 Bônus Exclusivos</span>
                </div>
              </div>
            </div>
