          ...
          >
            ...
            <div className="space-y-2 mb-5">
              <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
                <div className="bg-rose-100 border border-rose-200 rounded-lg px-2 py-2.5 flex min-w-0 items-center shadow-sm sm:px-3">
                  ...
                  <span className="min-w-0 break-words text-[11px] leading-tight sm:text-base text-gray-900 font-medium">6 Certificados Inclusos</span>
                </div>
                ...
                <div className="bg-rose-100 border border-rose-200 rounded-lg px-2 py-2.5 flex min-w-0 items-center shadow-sm sm:px-3">
                  ...
                  <span className="min-w-0 break-words text-[11px] leading-tight sm:text-base text-gray-900 font-medium">+11 Bônus Exclusivos</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-lg border-2 border-[hsl(var(--rose-primary))]/20 mb-5">
              ...
              <div className="grid grid-cols-2 gap-1.5 text-xs text-gray-600 sm:gap-2 sm:text-sm">
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 mr-1 text-green-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                   ...
                   <span className="text-xs leading-tight sm:text-base font-semibold">Pagamento único</span>
                </div>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 mr-1 text-green-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                   <span className="text-xs leading-tight sm:text-base font-semibold">Sem mensalidade</span>
                </div>
              </div>
            </div>
