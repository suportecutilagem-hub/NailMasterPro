...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-0",
  {
    variants: {
      variant: {
        default: "bg-[hsl(var(--rose-primary))] text-primary-foreground hover:bg-[hsl(var(--rose-secondary))] pink-shadow",
        destructive:
        ...
        cta: "bg-[hsl(var(--rose-primary))] text-white hover:bg-[hsl(var(--rose-secondary))] text-base font-bold transition duration-300 transform hover:scale-105 pink-shadow",
        white: "bg-white text-[hsl(var(--rose-primary))] hover:bg-gray-100",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-9 rounded-md px-3",
        lg: "h-11 rounded-md px-8",
        xl: "h-12 sm:h-14 rounded-md px-6 sm:px-8 py-3 text-base sm:text-lg",
        icon: "h-10 w-10",
      },
      roundedness: {
        default: "rounded-md",
